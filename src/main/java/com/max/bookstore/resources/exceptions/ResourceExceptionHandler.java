...
import com.max.bookstore.service.exceptions.DataIntegrityViolationException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> datatNotFoundException(DataIntegrityViolationException e,
	...
	public ResponseEntity<StandarError> validationError(MethodArgumentNotValidException e,
			ServletRequest request) {
